...
public class TimeLine extends Group {
	...
	private void drawTimeLine() {
		...
		for(int i = 0; i < timeLineMonths ;++i) {
			...
			super.getChildren().add(monthBar(monthName +" "+ yearValue, positionXM ));
			...
			for(int j = 0; j < monthDays ;++j) {
				...
				super.getChildren().add(new Rectangle(positionXD,297,1,3));
	...
	private void drawDuration() {
		...
		super.getChildren().addAll(durationLine, startLine, endLine, durationText);
	}
}
